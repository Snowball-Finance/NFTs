...
contract SnowballNFTRollingSasquatch is ERC721, Ownable{
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    uint public constant TOKEN_LIMIT = 5; // 5 for testing, 5 for prod;
    uint public constant MAX_MINTS_PER_ADDRESS = 5;
    uint public _price = 20000000000000000000; // 20 AVAX
    ...
    constructor() ERC721("Snowball NFT Rolling Sasquatch", "SNOBNFTROLLINGSASQUATCH") {

...
contract SnowballNFTCovidRelief is ERC721, Ownable{
    ...
    constructor() ERC721("Snowball NFT Covid Relief", "SNOBNFTCOVIDRELIEF") {
        setBaseURI("https://api.snowball.network/nft/covid_relief/");
    }
    ...
    function mint(address to) public payable{
        ...
        require(Wallets[to] == true, "invalid wallet address!");
    ...
    function setWallets(address[] memory addresses) public onlyOwner {
        uint i = 0;

...
contract SnowballNFTRollingPink is ERC721URIStorage, Ownable{
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    uint public constant TOKEN_LIMIT = 80; // 5 for testing, 80 for prod;
    uint public constant MAX_MINTS_PER_ADDRESS = 5;
    uint public _price = 1000000000000000000; // 1 AVAX

    address public _feeAddress = 0x36F90C2CA7E26b11D9Ad4c46eB50eE04D1ceD565;
    address payable _feeReceiver;
    string public _metadata = "";
    mapping (address => uint8) private _mintCounts;

    constructor() ERC721("Snowball NFT Rolling Pink", "SNOBNFTROLLINGPINK") {

...
contract SnowballNFTSnowBallHead is ERC721, Ownable{
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    uint public constant TOKEN_LIMIT = 150;
    uint public constant MAX_MINTS_PER_ADDRESS = 10;

    address public _feeAddress = 0x3B7631F8E3428dEaB77634BF799b622ce412e9Ea;
    address payable _feeReceiver;
    mapping (address => uint8) private _mintCounts;

    constructor() ERC721("Snowball NFT Snow Ball Head", "SNOBNFTSNOWBALLHEAD") {
        _feeReceiver = payable(_feeAddress);
        setBaseURI("https://api.snowball.network/nft/snowball_head/");
    }
    ...
    function calculatePrice() public view returns (uint256) {
        ...
        } else if (currentSupply >= 130) {
            return 2000000000000000000;
        } else if (currentSupply >= 120) {
            return 1000000000000000000;
        } else if (currentSupply >= 90) {

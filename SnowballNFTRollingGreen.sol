...
contract SnowballNFTRollingGreen is ERC721, Ownable{
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    uint public constant TOKEN_LIMIT = 40; // 5 for testing, 80 for prod;
    uint public constant MAX_MINTS_PER_ADDRESS = 5;
    uint public _price = 3000000000000000000; // 1 AVAX
    ...
    constructor() ERC721("Snowball NFT Rolling Green", "SNOBNFTROLLINGGREEN") {
